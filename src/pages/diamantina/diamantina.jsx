...
import './diamantina.css'
import DiamantinaSobre from '../../assets/images/Diamantina/diamantina1.jpg'
import DiamantinaIgrejas from '../../assets/images/Diamantina/diamantina2.jpg'
import DiamantinaMuseu from '../../assets/images/Diamantina/diamantina3.jpg'
import DiamantinaMercado from '../../assets/images/Diamantina/diamantina4.jpg'
import DiamantinaVila from '../../assets/images/Diamantina/diamantina5.png'
import DiamantinaCasa from '../../assets/images/Diamantina/diamantina6.jpg'
import DiamantinaMusica from '../../assets/images/Diamantina/diamantina7.jpg'

const Diamantina = () => {
    return (
        <div class="container-page">
            <p className="titulopag">DIAMANTINA</p>
            <p className="title title-alt">Sobre a cidade</p>
            <div class="tabela">
                <div>
                        <img className="imagens" width="400" height="250" src={DiamantinaSobre} alt="Imagem Diamantina" />
                </div>
                <div className="paragrafo1">
                Com mais de três séculos de fundação, passando de povoado a arraial até chegar a município, Diamantina é uma cidade rica em
                história e tradições. Possui um patrimônio arquitetônico, cultural e natural rico e preservado. A formação do município
                está intrinsecamente ligada à exploração do ouro e do diamante. A ocupação portuguesa do território se deu com Jerônimo
                Gouvêa, que, seguindo o curso do Rio Jequitinhonha, encontrou, nas confluências do Rio Piruruca e Rio Grande, uma grande
                quantidade de ouro. Atualmente, Diamantina é uma das cidades históricas mais conhecidas e visitadas do país. O casario
                colonial, de inspiração barroca; as edificações históricas; as igrejas seculares; a belíssima paisagem natural e uma forte
                tradição religiosa, folclórica e musical conferem uma singularidade especial à cidade.
            ...
            <div class="tabela">
                    ...
                    No centro histórico de Diamantina, se concentram as principais atrações para visitar na cidade. As igrejas e casarões
                    construídos em arquitetura colonial e preservados até os dias atuais, conferindo status de patrimônio cultural da Unesco,
                    os museus e locais que contam a história local, as ruas mais movimentadas, tudo estará aqui. Percorra suas ruas de pedra,
                    se perca entre uma atração e outra, mas não deixe de contemplar o charme da região central. Vale destacar também que é no
                    centro histórico onde acontecem eventos culturais importantes, como a Vesperata e o carnaval de Diamantina.
                    </div>
                    <div>
                        <img className="imagens" width="400" height="250" src={DiamantinaIgrejas} alt="Igreja de Diamantina" />
                    </div>
            ...
            <div className="tabela">
                    ...
                    <div>
                        <img className="imagens" width="400" height="250" src={DiamantinaMuseu} alt="Museu do diamante" />
                    </div>
                    <div className="paragrafo1">
            ...
            <div class="tabela">
                    ...
                    <div>
                        <img className="imagens" width="400" height="250" src={DiamantinaMercado} alt="Mercado velho" />
                    </div>
            ...
            <div className="tabela">
                    ...
                    <div>
                        <img className="imagens" width="400" height="250" src={DiamantinaVila} alt="Vila do Biribiri" />
                    </div>
                    <div className="paragrafo1">
            ...
            <div className="tabela">
                    ...
                    <div className="paragrafo2">
                        Visistação de casas de figuras históricas:
                        <br></br>
                        <br></br>
                        Em Diamantina, é possível visitar a casa do ex-presidente Juscelino Kubitschek e da grande figura histórica Chica
                        da Silva, já que ambos residiam na cidade.
                        <br></br>
                        <br></br>
                        Igreja de Nossa Senhora do Carmo:
                        <br></br>
                        <br></br>
                        Uma das igrejas da cidade, a Igreja de Nossa Senhora do Carmo é a única construção cujo campanário foi construído
                    ...
                    <div>
                        <img className="imagens" width="400" height="250" alt="DiamantinaCasa" src={DiamantinaCasa} />
                    </div>

            </div>
            <p className="title title-alt">A cidade musical de Minas Gerais</p>
            <div class="tabela">
                <div>
                        <img className="imagens" width="400" height="250" alt="DiamantinaMusica" src={DiamantinaMusica} />
                </div>
                <div className="paragrafo1">
